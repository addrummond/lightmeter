...
avr-gcc $CFLAGS $LINKFLAGS mymemset.out tables.out state.out bcd.out exposure.out display.out ui.out bitmaps.out basic_serial/basic_serial.out menu_strings_table.out menu_strings.out lightmeter.out shiftregister.out -o main.out
