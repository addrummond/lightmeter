...
avr-gcc $CFLAGS $LINKFLAGS mymemset.out tables.out divmulutils.out state.out bcd.out exposure.out display.out ui.out bitmaps.out lightmeter.out -o main.out
