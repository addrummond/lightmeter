...
void shutter_speed_to_string(ev_with_tenths_t shutter_speed, shutter_string_output_t *eso, uint8_t precision_mode);
...
// Note that this gives the tenth immediately <= the nearest eighth
// (i.e. it doesn't round up).
