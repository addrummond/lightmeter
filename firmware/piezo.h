...
#define PIEZO_HFSDP_A_MODE_MASTER_CLOCK_HZ    20000.0
#define PIEZO_HFSDP_A_MODE_MASTER_CLOCK_COEFF GOETZEL_FLOAT_TO_FIX(-1.2748451909216907)
#define PIEZO_HFSDP_A_MODE_MASTER_DATA_HZ     19000.0
#define PIEZO_HFSDP_A_MODE_MASTER_DATA_COEFF  GOETZEL_FLOAT_TO_FIX(-1.0927858139146585)
